    ...
    <footer className="py-10 sm:py-16 lg:py-20 relative bg-[#1E3A8A]">
      <div className="max-w-7xl mx-auto px-4 sm:px-6">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 sm:gap-12">
          <div className="space-y-6 sm:space-y-8">
            <div>
              <h3 className="font-bold text-[20px] sm:text-[24px] lg:text-[28px] text-[#F97316] mb-4 sm:mb-6">
                ÚNETE A NUESTRA CAUSA
              </h3>
              <p className="text-[16px] sm:text-[18px] lg:text-[20px] text-white/90 leading-[1.7] mb-6 sm:mb-8">
            ...
            <div className="space-y-4 sm:space-y-6">
              <div className="flex items-center gap-4">
                ...
                <div>
                <p className="font-bold text-[12px] sm:text-[14px] text-white/60 mb-1">Email</p>
                  <a 
                    href="mailto:comunica@adn-a.org"
                    className="font-medium text-[16px] sm:text-[18px] lg:text-[20px] text-white hover:text-[#F97316] transition-colors duration-200"
                  >
                    comunica@adn-a.org
                  </a>
                </div>
              ...
              <div className="flex items-center gap-4">
                ...
                <div>
                <p className="font-bold text-[14px] text-white/60 mb-1">WhatsApp</p>
                  <a 
              ...
              <div className="flex items-center gap-4">
                ...
                <div>
                <p className="font-bold text-[14px] text-white/60 mb-1">Canal de WhatsApp</p>
                  <a 
            ...
            <div className="pt-6 border-t border-white/20">
              <p className="font-bold text-[14px] sm:text-[16px] text-white/80 mb-3 sm:mb-4">Síguenos en redes sociales:</p>
              <div className="flex flex-col sm:flex-row gap-3 sm:gap-6">
                <a 
                  href="https://instagram.com/adn.ags"
                  target="_blank"
                  rel="noopener noreferrer"
                  className="flex items-center gap-2 font-medium text-[16px] sm:text-[18px] text-white hover:text-[#F97316] transition-colors duration-200"
                >
                  Instagram: @adn.ags
                </a>
              </div>
          ...
          <div className="bg-white/10 rounded-3xl p-6 sm:p-8 border border-white/20">
            <h4 className="font-bold text-[18px] sm:text-[20px] lg:text-[24px] text-[#F97316] mb-4 sm:mb-6">
            ...
            <ul className="space-y-3 sm:space-y-4">
              <li className="flex items-start gap-3">
                ...
                <span className="text-[16px] sm:text-[18px] text-white/90">
