    ...
    <nav className="fixed top-0 left-0 right-0 z-50 bg-white/95 backdrop-blur-sm border-b border-[#1E3A8A]/10 shadow-sm">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 py-3 sm:py-4">
        <div className="flex justify-between items-center">
          <div className="flex items-center flex-shrink-0 h-[400px] sm:h-24">
            <Link href="/" className="flex items-center h-full">
              ...
              <svg 
                ...
                className="block sm:hidden h-[400px] w-auto flex-shrink-0"
              >
              ...
              <img 
                ...
                className="hidden sm:block sm:h-[95%] sm:w-auto"
              />
            </Link>
          </div>
